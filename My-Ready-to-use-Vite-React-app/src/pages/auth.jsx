...
const Auth = () => {
    ...
    // console.log("authToggle",authToggle)
  ...
  return (
    <main className={styles.container}>
        <nav className={styles.nvbarContainer}>
            <Navbar/>
        </nav>
        ...
        <div className={styles.mainContainer}>
            ...
            {authToggle?
                (
            <section className={styles.semiContainer2}>
                ...
                <section className={styles.detailContainer}>
                    ...
                    <div className={styles.inputContainer3}>
                        ...
                        <p className={styles.text3} style={{fontSize:"0.8rem"}}>Don't have an account? <span style={{color:'#111727',cursor:"pointer"}} onClick={()=>{dispatch(AuthToggleChanger(false))}}>Signup</span></p>
            ...
            (
                <section className={styles.semiContainer}>
                    ...
                    <section className={styles.detailContainer}>
                        ...
                        <input placeholder='gg' className={styles.inputwrapper3} type="checkbox" value={radioCheck} checked={radioCheck?"checked":""} onChange={()=>{setRadioCheck(!radioCheck)}}/>
                        ...
                        <div className={styles.inputContainer3}>
                            ...
                            <p className={styles.text3}>Have an account? <span style={{color:'#111727',cursor:"pointer"}} onClick={()=>{window.scrollTo(0, 0);dispatch(AuthToggleChanger(true))}}>Login</span></p>
